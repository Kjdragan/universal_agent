...
GATEWAY_MEMORY_HIGH="${UA_GATEWAY_MEMORY_HIGH:-1800M}"
GATEWAY_MEMORY_MAX="${UA_GATEWAY_MEMORY_MAX:-2400M}"
GATEWAY_MEMORY_SWAP_MAX="${UA_GATEWAY_MEMORY_SWAP_MAX:-1500M}"
