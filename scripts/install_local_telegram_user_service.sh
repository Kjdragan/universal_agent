...
SRC_UNIT="$REPO_ROOT/deployment/systemd-user/universal-agent-telegram.service"
DEST_DIR="${HOME}/.config/systemd/user"
DEST_UNIT="${DEST_DIR}/universal-agent-telegram.service"
...
systemctl --user enable --now universal-agent-telegram.service
systemctl --user --no-pager --full status universal-agent-telegram.service || true
