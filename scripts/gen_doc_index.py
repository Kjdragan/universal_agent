...
META_ORDER = [
    ...
    ("00_PROJECT_AT_A_GLANCE.md",
     "**10-minute onboarding snapshot** — the 12 \"greatest hits\" (topology, task flow, schedulers, "
     "CSI pipeline, VPs, model routing, deploy) as diagrams + tables, each linking its canonical doc."),
