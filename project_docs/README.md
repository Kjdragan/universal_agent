...
- **[Task Type & Mission System Registry](01_architecture/07_task_type_registry.md)** — Canonical catalog of every task type / mission system with lifecycle status (canonical/active_secondary/deprecated/removed) _(verified 2026-06-06)_
...
_55/55 canonical docs present. Legacy point-in-time reports are archived (search-excluded) — see `00_DOCUMENTATION_REFACTOR_PLAN.md` §5._
