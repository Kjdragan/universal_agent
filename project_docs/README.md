...
- **[System Architecture Overview](01_architecture/01_system_overview.md)** — Top-level topology: principals (Simone/Cody/Atlas), gateway, what-talks-to-what, process model. _(verified 2026-06-22)_
...
- **[Gateway, Sessions & Execution](02_execution_core/01_gateway_sessions_execution.md)** — Gateway protocol, InProcessGateway, ProcessTurnAdapter, session lifecycle/locking, WebSocket streaming, timeouts. _(verified 2026-06-19)_
...
- **[Dormancy & Operating Hours](08_operations/03_dormancy_and_operating_hours.md)** — 6AM-10PM Houston active window, content-gen vs infra-event distinction, documented exceptions, guard test. _(verified 2026-06-22)_
