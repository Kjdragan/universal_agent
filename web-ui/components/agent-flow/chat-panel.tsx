...
import { CARD, Z, type AgentState } from '@/lib/agent-flow/agent-types'
import { COLORS, getStateColor } from '@/lib/agent-flow/colors'
...
import { useAutoScroll } from '@/hooks/agent-flow/use-auto-scroll'
