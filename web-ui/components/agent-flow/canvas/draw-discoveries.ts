import { Agent, Discovery } from '@/lib/agent-flow/agent-types'
import { COLORS, getDiscoveryTypeColor } from '@/lib/agent-flow/colors'
import { getDiscoveryCardDimensions } from '@/lib/agent-flow/canvas-constants'
