...
import { Agent, Particle, Edge, Discovery, DepthParticle } from '@/lib/agent-flow/agent-types'
...
import { useCanvasInteraction } from '@/hooks/agent-flow/use-canvas-interaction'
