...
This is a tool call the agent makes autonomously - you don’t write this code yourself. The agent decides when and how to update its memory based on the conversation.
