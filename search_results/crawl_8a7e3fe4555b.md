---
title: "Train models with billions of parameters using FSDP — PyTorch Lightning 2.6.0 documentation"
source: https://lightning.ai/docs/pytorch/stable/advanced/model_parallel/fsdp.html
date: unknown
description: ""
word_count: 2370
---

Table of Contents [](https://lightning.ai/docs/pytorch/stable/advanced/model_parallel/<#>)
  * Overview
  * Team management
  * Open source
    * Overview
...
Shortcuts 
# Train models with billions of parameters using FSDP[](https://lightning.ai/docs/pytorch/stable/advanced/model_parallel/<#train-models-with-billions-of-parameters-using-fsdp>)
...
## Enable FSDP in Trainer[](https://lightning.ai/docs/pytorch/stable/advanced/model_parallel/<#enable-fsdp-in-trainer>)
...
```
fromlightning.pytorch.strategiesimport FSDPStrategy
...
importlightningasL
fromlightning.pytorch.strategiesimport FSDPStrategy
fromlightning.pytorch.demosimport Transformer, WikiText2

classLanguageModel(L.LightningModule):
...
## Identify large layers[](https://lightning.ai/docs/pytorch/stable/advanced/model_parallel/<#identify-large-layers>)
...
fromtorch.distributed.fsdp.wrapimport size_based_auto_wrap_policy
...
Numbers were produced with A100 40GB GPUs, Lightning 2.1 and PyTorch 2.1.[](https://lightning.ai/docs/pytorch/stable/advanced/model_parallel/<#id1>) DDP | FSDP  
---|---  
Memory (MB) | 23’125 | 9’627  
Iterations per second | 4.31 | 3.19  
## Speed up model initialization[](https://lightning.ai/docs/pytorch/stable/advanced/model_parallel/<#speed-up-model-initialization>)
...
## Optimize the sharding strategy[](https://lightning.ai/docs/pytorch/stable/advanced/model_parallel/<#optimize-the-sharding-strategy>)
...
Numbers were produced with A100 40GB GPUs, Lightning 2.1 and PyTorch 2.1.[](https://lightning.ai/docs/pytorch/stable/advanced/model_parallel/<#id2>) DDP | NO_SHARD | SHARD_GRAD_OP | FULL_SHARD  
---|---|---|---  
Memory (MB) | 23’125 | 19’296 | 11’772 | 9’627  
Iterations per second | 4.31 | 3.04 | 3.61 | 3.19  
## Trade-off speed for memory[](https://lightning.ai/docs/pytorch/stable/advanced/model_parallel/<#trade-off-speed-for-memory>)
...
### Activation checkpointing[](https://lightning.ai/docs/pytorch/stable/advanced/model_parallel/<#activation-checkpointing>)
...
### Offload parameters to CPU[](https://lightning.ai/docs/pytorch/stable/advanced/model_parallel/<#offload-parameters-to-cpu>)
...
Numbers were produced with A100 40GB GPUs, Lightning 2.1 and PyTorch 2.1.[](https://lightning.ai/docs/pytorch/stable/advanced/model_parallel/<#id3>) DDP | FSDP | FSDP + CPU offload  
---|---|---  
Memory (MB) | 23’125 | 9’627 | 2’790  
Iterations per second | 4.31 | 3.19 | 0.02  
## Save a checkpoint[](https://lightning.ai/docs/pytorch/stable/advanced/model_parallel/<#save-a-checkpoint>)
...
## Load a checkpoint[](https://lightning.ai/docs/pytorch/stable/advanced/model_parallel/<#load-a-checkpoint>)
...
## Advanced performance optimizations[](https://lightning.ai/docs/pytorch/stable/advanced/model_parallel/<#advanced-performance-optimizations>)
...
### Disable foreach in the optimizer[](https://lightning.ai/docs/pytorch/stable/advanced/model_parallel/<#disable-foreach-in-the-optimizer>)
...
### Limit all-gathers[](https://lightning.ai/docs/pytorch/stable/advanced/model_parallel/<#limit-all-gathers>)
...
### Manual wrapping[](https://lightning.ai/docs/pytorch/stable/advanced/model_parallel/<#manual-wrapping>)
...
importtorch.nnasnn
importlightningasL
fromtorch.distributed.fsdp.wrapimport wrap

classMyModel(L.LightningModule):
  defconfigure_model(self):
