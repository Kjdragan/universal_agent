...
A newer version of this model is available: meta-llama/Llama-3.1-70B
...
Downloads last month
    408,244 
Safetensors[](https://huggingface.co/meta-llama/<https:/huggingface.co/docs/safetensors>)
Model size
71B params
Tensor type
BF16 
·
Files info
##  Model tree for meta-llama/Meta-Llama-3-70B [](https://huggingface.co/meta-llama/</docs/hub/model-cards#specifying-a-base-model>)
Adapters
6 models
Finetunes
38 models
...
Quantizations
24 models
##  Spaces using meta-llama/Meta-Llama-3-70B 100
##  Collection including meta-llama/Meta-Llama-3-70B
