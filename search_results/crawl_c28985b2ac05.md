---
title: "NousResearch/Meta-Llama-3-70B · Hugging Face"
source: https://huggingface.co/NousResearch/Meta-Llama-3-70B
date: 2024-04-18
...
Downloads last month
    362 
Safetensors[](https://huggingface.co/NousResearch/<https:/huggingface.co/docs/safetensors>)
Model size
71B params
Tensor type
BF16 
·
Files info
##  Model tree for NousResearch/Meta-Llama-3-70B [](https://huggingface.co/NousResearch/</docs/hub/model-cards#specifying-a-base-model>)
Adapters
4 models
Finetunes
1 model
Quantizations
2 models
##  Spaces using NousResearch/Meta-Llama-3-70B 14
