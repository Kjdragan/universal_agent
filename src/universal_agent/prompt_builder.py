...
def build_system_prompt(
    *,
    ...
    sections.append(
        ...
        "   - HTML/PDF report? -> Use the `modular-research-report-expert` **skill** (Agent Teams pipeline with 6 specialized teammates, critique loops, and visual design). "
        "Invoke it via `/modular-research-report-expert` or the Skill tool. "
    ...
    sections.append(
        ...
        "- Then generate the report using the **`modular-research-report-expert` skill** (6-teammate Agent Teams pipeline with critique loops and visual design). "
        "Invoke it via `/modular-research-report-expert` or the Skill tool. "
        "Fall back to the `report-writer` sub-agent ONLY if Agent Teams is unavailable or the skill fails.\n"
