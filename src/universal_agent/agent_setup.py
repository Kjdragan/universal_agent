...
class AgentSetup:
    ...
    def _build_system_prompt(self, workspace_path: str, agents: Optional[dict] = None) -> str:
        ...
        prompt = (
            ...
            "- **Intelligence**: Composio search, browserbase web scraping, URL/PDF extraction\n"
            ...
            "- **Communication**: Gmail (`mcp__composio__GMAIL_*`), Slack (`mcp__composio__SLACK_*`), Calendar (`mcp__composio__GOOGLECALENDAR_*`)\n"
            "- **Real-World Actions**: GoPlaces, browser automation (`browserbase`), form filling\n"
