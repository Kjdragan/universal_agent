...
class UniversalAgent:
    ...
    def _build_system_prompt(self, workspace_path: str) -> str:
        ...
        return (
            ...
            "   -> You are FORBIDDEN from writing reports or doing deep research yourself.\n"
            ...
            "   'Extract full content from the search results using crawl_parallel, then write a report.'\n"
    ...
    def _build_subagent_prompt(self, workspace_path: str) -> str:
        ...
        return (
            ...
            "## MANDATORY WORKFLOW\n\n"
            "### Step 1: Extract Content from URLs (MANDATORY)\n"
            "When given source URLs (or search result JSONs containing URLs):\n"
            "1. **Identify URLs:** If given search result files, READ them to extract the URLs first.\n"
            "2. **Crawl:** Call `crawl_parallel` with the list of extracted URLs.\n"
            "2. This creates:\n"
            f"   - `{workspace_path}/search_results/research_overview.md`: All sources with metadata and 1000-word excerpts\n"
            "   - Individual `crawl_*.md` files: Full article content\n"
            "❌ NEVER skip this step. Search snippets are insufficient for professional reports.\n\n"
            ...
            "- Source citations linking to original URLs\n"
