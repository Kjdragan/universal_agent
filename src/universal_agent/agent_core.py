...
class UniversalAgent:
    ...
    def _build_system_prompt(self, workspace_path: str, agents: Optional[dict] = None) -> str:
        ...
        prompt = (
            ...
            "- `mcp__internal__*` - Local tools (file I/O, research, image gen) → Call these directly\n"
            ...
            "- **Tool Usage:** Do NOT write Python scripts to call other tools. Use `mcp__internal__batch_tool_execute` for multiple searches.\n"
    ...
    def _build_research_specialist_prompt(self, workspace_path: str) -> str:
        ...
        prompt = (
            ...
            "**IMMEDIATELY** call `mcp__internal__finalize_research`:\n"
