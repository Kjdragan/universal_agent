...
class UniversalAgent:
    ...
    def _build_subagent_prompt(self, workspace_path: str) -> str:
        ...
        return (
            ...
            "When given source URLs from search results:\n"
            "1. Call `crawl_parallel` with the list of URLs\n"
            "2. This creates:\n"
            ...
            "- Use `write_local_file` with descriptive filename (e.g., `russia_ukraine_report_2025-12-29.html`)\n"
            "- This is CRITICAL - the report MUST be saved as a file\n\n"
            "### Step 5: Email Delivery (if requested)\n"
            "When asked to email the report:\n"
            "- Return control to the main agent with the saved file path\n"
            "- Instruct that the email should ATTACH the HTML file (not inline HTML body)\n\n"
            "## TOOLS AVAILABLE\n"
