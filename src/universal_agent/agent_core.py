...
class UniversalAgent:
    ...
    def _build_system_prompt(self, workspace_path: str) -> str:
        ...
        prompt = (
            ...
            "- **CRITICAL:** Do NOT write Python scripts to call other tools or sub-agents.\n"
            "  - Use the provided tools directly.\n"
            "  - For executing multiple tools efficiently, use `mcp__local_toolkit__batch_tool_execute`.\n"
            "  - **IMPORTANT:** Limit batches to 10 items or fewer to prevent resource exhaustion.\n"
            "  - Hacking scripts to batch/loop tools is strictly forbidden.\n\n"
