...
Run `scripts/publish_scratch.sh <file> [slug]` — it prints the URL on stdout. Mechanism, URL shape, and the tailnet-only privacy boundary: [`project_docs/06_platform/06_networking_tailscale_proxy_sshfs.md`](project_docs/06_platform/06_networking_tailscale_proxy_sshfs.md) § 1.6.
