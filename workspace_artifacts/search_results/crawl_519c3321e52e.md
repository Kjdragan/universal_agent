...
Younes B ybelkada Follow 

Tim Dettmers timdettmers Follow 
guest

Artidoro Pagnoni artidoro Follow 
guest

Sylvain Gugger sgugger Follow 

Sourab Mangrulkar smangrul Follow 
...
---  
**Overview of Floating Point 8 (FP8) format. Source: Original content from`sgugger`[](https://huggingface.co/blog/<https:/huggingface.co/sgugger>) **  
...
45 March 18, 2024 dacorvo, et. al.](https://huggingface.co/blog/</blog/quanto-introduction>)
...
13 September 12, 2023 ybelkada, et. al.](https://huggingface.co/blog/</blog/overview-quantization-transformers>)
### Community
...
liam255
Dec 17, 2025
Really cool insights! Makes me want to push the limits of my own chatbots. With CustomGPT, I’ve been able to build bots that understand my content deeply and respond naturally. Seeing tools like QLoRA and 4-bit models makes advanced LLMs feel way more approachable for anyone experimenting
Reply
EditPreview
