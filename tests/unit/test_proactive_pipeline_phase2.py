...
class TestReportDataGathering:
    ...
    def test_gather_stats_returns_proactive_task_counts(self, tmp_path):
        ...
        from universal_agent.services.proactive_intelligence_report import gather_pipeline_stats
...
class TestReportLLMReasoning:
    ...
    async def test_compose_report_includes_llm_analysis(self, tmp_path):
        ...
        from universal_agent.services.proactive_intelligence_report import compose_intelligence_report
...
class TestUtilizationTracking:
    ...
    def test_record_utilization_sample(self, tmp_path):
        ...
        from universal_agent.services.proactive_intelligence_report import record_utilization_sample, get_utilization_stats
...
class TestReportEmailFormat:
    ...
    async def test_report_email_includes_key_sections(self, tmp_path):
        ...
        from universal_agent.services.proactive_intelligence_report import format_report_email
