...
class TestRedisVpBridge:
    @pytest.mark.asyncio
    async def test_inserts_coding_mission(self, db):
        ...
        inserted = await bridge.run(once=True)
    ...
    @pytest.mark.asyncio
    async def test_inserts_general_mission(self, db):
    ...
    @pytest.mark.asyncio
    async def test_unknown_kind_defaults_to_general(self, db):
    ...
    @pytest.mark.asyncio
    async def test_skips_tutorial_bootstrap_repo(self, db):
    ...
    @pytest.mark.asyncio
    async def test_idempotent_duplicate_acked(self, db):
    ...
    @pytest.mark.asyncio
    async def test_empty_consume_returns_zero(self, db):
        bus = _mock_bus([])
        bridge = RedisVpBridge(bus, db, BridgeConfig())
        inserted = await bridge.run(once=True)
        assert inserted == 0
    ...
    @pytest.mark.asyncio
    async def test_insertion_failure_triggers_dlq(self, db):
    ...
    @pytest.mark.asyncio
    async def test_metrics_track_counts(self, db):
    ...
    @pytest.mark.asyncio
    async def test_pause_skips_work_missions(self, db):
    ...
    @pytest.mark.asyncio
    async def test_resume_allows_work_missions(self, db):
    ...
    @pytest.mark.asyncio
    async def test_system_mission_pause_signal(self, db):
    ...
    @pytest.mark.asyncio
    async def test_system_mission_resume_signal(self, db):
    ...
    @pytest.mark.asyncio
    async def test_system_missions_processed_when_paused(self, db):
