...
If the user explicitly wants a temporary output for the current run only, write it under `CURRENT_RUN_WORKSPACE/` (`CURRENT_SESSION_WORKSPACE` remains a legacy alias).
