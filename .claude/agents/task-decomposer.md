...
| `trend-specialist` | X/Web pulse checks, "what's new" | x internal tools (+ CSI work-product tools) |
| `csi-trend-analyst` | CSI report/bundle review and bounded follow-up synthesis | CSI work-product tools + x validation |
