...
Four operator-driven actions added in [PR #195](https://github.com/Kjdragan/universal_agent/pull/195) to unstick tasks that have wedged in `needs_review` or `blocked` because the heartbeat / todo retry budget tripped — without losing the task body, comments, or history.
