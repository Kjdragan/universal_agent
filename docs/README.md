...
- **[ClaudeDevs X Intelligence Lane Deferred Design (2026-04-19)](03_Operations/117_ClaudeDevs_X_Intelligence_Lane_Deferred_Design_2026-04-19.md)**: Deferred design note for a dedicated Claude Code intelligence lane monitoring `@ClaudeDevs`, including tiering, KB/wiki expectations, source-access findings, mirror fallback, and resume checklist.
