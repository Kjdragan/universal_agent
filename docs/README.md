...
- **[Task Forge: Autonomous Skill Generation Pipeline (2026-04-19)](03_Operations/119_Task_Forge_Autonomous_Skill_Generation_Pipeline_2026-04-19.md)**: Canonical source of truth for Task Forge — the meta-skill that converts human intent into structured, reusable task-skills. Covers the 7-phase pipeline (intent → scaffold → execute → quality gate → archive/promote), skill maturity model (v0→v3), dispatch integration, hook hardening, skill-creator relationship, recursive learning loop philosophy, and the paper-to-podcast cross-skill orchestration case study.
