...
| Field | Value |
|-------|-------|
| **Run ID** | `28484167-8046-4789-af8c-d18b6f18dbd9` |
| **Run Source** | `user` |
...
- **Logfire URL**: [019c3bb7108df991b9f7e7dd75112e11](https://logfire.pydantic.dev/Kjdragan/composio-claudemultiagent?q=trace_id%3D%27019c3bb7108df991b9f7e7dd75112e11%27)
...
SELECT * FROM records WHERE trace_id = '019c3bb7108df991b9f7e7dd75112e11'
-- Or by run_id
SELECT * FROM records WHERE attributes->>'run_id' = '28484167-8046-4789-af8c-d18b6f18dbd9'
```
