...
| Field | Value |
|-------|-------|
| **Run ID** | `1a33621c-34dd-4777-ab02-e7be117f7155` |
| **Run Source** | `user` |
...
- **Logfire URL**: [019c3bab90409380f7899a518f23b78e](https://logfire.pydantic.dev/Kjdragan/composio-claudemultiagent?q=trace_id%3D%27019c3bab90409380f7899a518f23b78e%27)
...
SELECT * FROM records WHERE trace_id = '019c3bab90409380f7899a518f23b78e'
-- Or by run_id
SELECT * FROM records WHERE attributes->>'run_id' = '1a33621c-34dd-4777-ab02-e7be117f7155'
```
