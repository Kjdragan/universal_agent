...
| Field | Value |
|-------|-------|
| **Run ID** | `302a9d8c-b9a5-4554-a9a8-8ae63ef3d171` |
| **Run Source** | `user` |
...
- **Logfire URL**: [019c3bab45bc7ba5713ce8edff86ef41](https://logfire.pydantic.dev/Kjdragan/composio-claudemultiagent?q=trace_id%3D%27019c3bab45bc7ba5713ce8edff86ef41%27)
...
SELECT * FROM records WHERE trace_id = '019c3bab45bc7ba5713ce8edff86ef41'
-- Or by run_id
SELECT * FROM records WHERE attributes->>'run_id' = '302a9d8c-b9a5-4554-a9a8-8ae63ef3d171'
```
