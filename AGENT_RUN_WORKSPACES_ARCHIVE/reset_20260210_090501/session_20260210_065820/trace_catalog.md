...
| Field | Value |
|-------|-------|
| **Run ID** | `fd7c10f5-ff72-4b7c-ac34-a68d3fa50ddd` |
| **Run Source** | `user` |
...
- **Logfire URL**: [019c47a1957295ab5aec3c009a469161](https://logfire.pydantic.dev/Kjdragan/composio-claudemultiagent?q=trace_id%3D%27019c47a1957295ab5aec3c009a469161%27)
...
SELECT * FROM records WHERE trace_id = '019c47a1957295ab5aec3c009a469161'
-- Or by run_id
SELECT * FROM records WHERE attributes->>'run_id' = 'fd7c10f5-ff72-4b7c-ac34-a68d3fa50ddd'
```

## 2. Local Toolkit Trace IDs
- Local toolkit spans are embedded under the **main trace** (no separate trace IDs).
- Shared Trace ID: `019c47a1957295ab5aec3c009a469161`
