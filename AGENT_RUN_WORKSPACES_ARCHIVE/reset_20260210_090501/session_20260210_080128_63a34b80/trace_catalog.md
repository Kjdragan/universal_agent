...
| Field | Value |
|-------|-------|
| **Run ID** | `f5ffd483-c087-4250-a81d-f53bcdaa7a95` |
| **Run Source** | `user` |
...
- **Logfire URL**: [019c47db82e038201cecca3b3b873795](https://logfire.pydantic.dev/Kjdragan/composio-claudemultiagent?q=trace_id%3D%27019c47db82e038201cecca3b3b873795%27)
...
SELECT * FROM records WHERE trace_id = '019c47db82e038201cecca3b3b873795'
-- Or by run_id
SELECT * FROM records WHERE attributes->>'run_id' = 'f5ffd483-c087-4250-a81d-f53bcdaa7a95'
```
