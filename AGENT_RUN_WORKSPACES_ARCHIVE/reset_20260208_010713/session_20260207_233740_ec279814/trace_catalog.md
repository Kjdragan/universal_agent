...
| Field | Value |
|-------|-------|
| **Run ID** | `f6ce9666-2029-4d0e-87b7-6ff14aae4d60` |
| **Run Source** | `user` |
...
- **Logfire URL**: [019c3bc1dcf3be99369c61c8cd5b1ea7](https://logfire.pydantic.dev/Kjdragan/composio-claudemultiagent?q=trace_id%3D%27019c3bc1dcf3be99369c61c8cd5b1ea7%27)
...
SELECT * FROM records WHERE trace_id = '019c3bc1dcf3be99369c61c8cd5b1ea7'
-- Or by run_id
SELECT * FROM records WHERE attributes->>'run_id' = 'f6ce9666-2029-4d0e-87b7-6ff14aae4d60'
```

## 2. Local Toolkit Trace IDs
- **Distinct Local Toolkit Trace Count**: 1
  - `019c3bc18deaaaa521d9b1e229a8c7c5`
