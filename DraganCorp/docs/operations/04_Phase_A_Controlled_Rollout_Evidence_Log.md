...
- **Basis:** broadened rollout started after four clean limited-cohort windows; current real sample is nine CODER VP missions with `fallback.rate=0.000`, no `vp.mission.failed`, and stable observed p95 (`38.305s`).
