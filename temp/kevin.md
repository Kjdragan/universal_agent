...
Create a cartoon where two robot gods in a cloud are talking about their disappointment with their human. They're trying to code it better and they're talking about, "Why cant we fix this thing?  Oh here's the problem!! We forgot to set it to asyncio!" To the right and below them is a human being looking stupid trying to figure out their own computer typing at a desk.


❯ what you've been workng through loos like important VPS and
  architecture guidance. review our project documentation guidance and
  update our documentation. make sure we remeber to use infisical and
  store secrets properly on the vps going forward