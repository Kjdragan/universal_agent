...
date: 2026-01-15
description: "Keep track of updates to the Gemini API"
word_count: 3687
---
...
## January 15, 2026
  * Deprecation announcement: The following models will be shut down February 17, 2026:
...
**Model updates:**
  ...
  * Released the `gemini-2.5-pro-preview-tts`[](https://ai.google.dev/gemini-api/docs/</gemini-api/docs/models#gemini-2.5-pro-preview-tts>) and `gemini-2.5-flash-preview-tts`[](https://ai.google.dev/gemini-api/docs/</gemini-api/docs/models#gemini-2.5-flash-preview-tts>) models, which are capable of generating speech with one or two speakers.
...
**Model updates:**
  ...
  * Released support for two new parameters for Gemini 1.5 Pro and 1.5 Flash in Python and NodeJS: `frequencyPenalty`[](https://ai.google.dev/gemini-api/docs/</api/generate-content#FIELDS.frequency_penalty>) and `presencePenalty`[](https://ai.google.dev/gemini-api/docs/</api/generate-content#FIELDS.presence_penalty>).
...
**API updates:**
  ...
  * Added support for prompting with text, image, and audio data, also known as _multimodal_ prompting. To learn more, see Prompting with media.
