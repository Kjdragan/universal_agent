...
- Bundle ID: `2-agent-loop-sub-agent-summaries-now-hit-the-prompt-cache-opt-in-1`
...
• 1M-context sessions use their full window before hitting "Prompt is too lon
