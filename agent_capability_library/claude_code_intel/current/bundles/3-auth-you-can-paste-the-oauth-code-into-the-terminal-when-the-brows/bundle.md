...
• You can paste the OAuth code into the terminal when the brows

- Bundle ID: `3-auth-you-can-paste-the-oauth-code-into-the-terminal-when-the-brows`
...
• Refresh tokens are protected against a rare concurrent-write race
