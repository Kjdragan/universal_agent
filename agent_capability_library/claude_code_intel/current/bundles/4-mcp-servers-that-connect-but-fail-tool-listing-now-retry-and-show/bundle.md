...
• Servers that connect but fail tool listing now retry and show 

- Bundle ID: `4-mcp-servers-that-connect-but-fail-tool-listing-now-retry-and-show`
...
• Servers that connect but fail tool listing now retry and show a clear status in /mcp
• Tool results with images and structured content now keep the images
• Reconnecting servers announce a summary instead of their full tool list
