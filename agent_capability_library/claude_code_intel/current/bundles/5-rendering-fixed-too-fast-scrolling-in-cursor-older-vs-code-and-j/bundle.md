...
• Fixed too-fast scrolling in Cursor, older VS Code, and J

- Bundle ID: `5-rendering-fixed-too-fast-scrolling-in-cursor-older-vs-code-and-j`
...
• Fixed too-fast scrolling in Cursor, older VS Code, and JetBrains terminals
• Japanese/Korean/Chinese text renders correctly on Windows in no-flicker mode
• Pasting text that starts with / now lands in the prompt
• Ctrl+L redraws the screen and 
...
• Japanese/Korean/Chinese text renders correctly on Windows in no-flicker mode
• Pasting text that starts with / now lands in the prompt
• Ctrl+L redraws the screen and keeps your input
